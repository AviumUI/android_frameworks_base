...
public abstract class BaseGuoguoClockController extends BaseLockscreenController {

    protected static final float SCALE_FACTOR = 0.5f;

    protected TextView mDateView;
    protected ImageView mHour1, mHour2, mMinute1, mMinute2;
    protected ImageView mDotView;
    protected ImageView[] mDigitViews;
    protected DigitalClockDisplayManager mDigitalClockDisplayManager;

    protected boolean mUseBlurEffect;
    protected GlassClockManager mGlassClockManager;

    protected LockscreenLayoutManager mLayoutManager;

    protected abstract int[] getDigitResources();
    protected abstract int getDotResource();
    ...
    private void createViews() {
        ...
        Drawable sampleDigitDrawable = mContext.getResources().getDrawable(getDigitResources()[0], mContext.getTheme());
        ...
        Drawable dotDrawable = mContext.getResources().getDrawable(getDotResource(), mContext.getTheme());
        ...
        if (mUseBlurEffect) {
            mGlassClockManager = new GlassClockManager(mContext, 4, getDigitResources());
            mGlassClockManager.setDotResource(getDotResource());
            ...
            mDotView.setImageResource(getDotResource());
            mContainer.addView(mDotView);
            
            mDigitalClockDisplayManager = new DigitalClockDisplayManager(mDigitViews, getDigitResources());
        }
    }
    ...
    public void applyStyles() {
        ...
        if (!mUseBlurEffect) {
            mDotView.setColorFilter(dotColor);
