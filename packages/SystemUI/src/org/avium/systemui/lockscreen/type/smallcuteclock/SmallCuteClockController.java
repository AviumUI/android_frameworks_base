...
//大小
    ...
    private void createViews() {
        ...
        mHour1.setId(View.generateViewId());
        mHour2 = new ImageView(mContext);
        mHour2.setId(View.generateViewId());
        mMinute1 = new ImageView(mContext);
        mMinute1.setId(View.generateViewId());
        mMinute2 = new ImageView(mContext);
        mMinute2.setId(View.generateViewId());
    ...
    private void setupLayout() {
        ...
        for (int id : clockViewIds) {
            ...
            cs.setVerticalBias(id, 0.2f); //顶部距离
        }

        cs.connect(mDateView.getId(), ConstraintSet.BOTTOM, mHour1.getId(), ConstraintSet.TOP, 50); // 与时钟的间距
